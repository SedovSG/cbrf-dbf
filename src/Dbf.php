...
class Dbf
{
   ...
   */
	...
	{
    $this->update = new Update($dirName);
	}
  ...
  {
    return $this->update->getPathToDbf();
  }
  ...
  {
    return $this->update->downloadZip();
  }
